...
public class JdbcStorageConfigManager {
  ...
  public static final String CONFIG_USERNAME = JDBC_USERNAME;
  public static final String CONFIG_PWD = JDBC_PASSWORD;
  public static final String CONFIG_PWD_KEYSTORE = JDBC_KEYSTORE;
  public static final String CONFIG_PWD_KEY = JDBC_KEY;
